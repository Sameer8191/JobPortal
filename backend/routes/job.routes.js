...
import { createJob, getAllJobs, getDashboardStats, getJobById, getJobsyAdmin, updateJob, deleteJob, closeJob } from '../controllers/job.controller.js';
...
jobRouter.get("/admin/jobs", authMiddleware, authorize("admin"), getJobsyAdmin);
